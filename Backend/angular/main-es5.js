(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
            ...
            var ErrorInterceptor = /** @class */ (function () {
                ...
                ErrorInterceptor.prototype.intercept = function (req, next) {
                    ...
                    return next.handle(req).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_1__["catchError"])(function (error) {
                        ...
                        _this.dialog.open(_error_error_component__WEBPACK_IMPORTED_MODULE_5__["ErrorComponent"], { data: { message: errorMassage } });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HederComponent = /** @class */ (function () {
                ...
                HederComponent.prototype.ngOnDestroy = function () {
                    this.authListenerSubs.unsubscribe();
                };
                HederComponent.prototype.logOut = function () {
                    this.authService.logUot();
                };
                return HederComponent;
            }());
            HederComponent.ctorParameters = function () { return [
                { type: _services_auth_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostCreateComponent = /** @class */ (function () {
                ...
                PostCreateComponent.prototype.ngOnInit = function () {
                    ...
                    this.router.paramMap.subscribe(function (paraMap) {
                        if (paraMap.has('postId')) {
                            _this.mode = 'edit';
                            _this.postId = paraMap.get('postId');
                            _this.isLoading = true;
                            _this.postService.getOnePost(_this.postId)
                ...
                PostCreateComponent.prototype.onFilePicked = function (event) {
                    var _this = this;
                    this.isURLok = false;
            ...
            var PostListComponent = /** @class */ (function () {
                ...
                PostListComponent.prototype.ngOnInit = function () {
                    ...
                    this.postService.getPostUpdateListener()
                        .subscribe(function (postData) {
                        _this.post = postData.post;
                        _this.totalPosts = postData.postCounter;
                        _this.isLoading = false;
                    });
                    this.userIsAuthenticated = this.authService.getIsAuth();
                    this.authListenerSubs = this.authService.getAuthStatusListener()
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.createUser = function (emial, password_) {
                    var _this = this;
                ...
                // tslint:disable-next-line:variable-name
                AuthService.prototype.login = function (emial, password_) {
                    var _this = this;
                    var authData = {
                        email: emial,
                        password: password_
                    ...
                    this.http.post(backendUrl + '/login', authData)
                        ...
                        if (res.token != null) {
                            ...
                            var now = new Date();
                            var expirationDate = new Date(now.getTime() + res.expiresIn * 1000);
                            // console.log(expirationDate);
                            _this.saveAuthData(res.token, expirationDate, _this.userId);
                            _this.router.navigate(['/']);
                        }
                    }, function (error) {
                        _this.authStatusListener.next(false);
                ...
                AuthService.prototype.logUot = function () {
                    this.authtoken = null;
                    this.userId = null;
                    this.isAuthenticated = false;
                ...
                AuthService.prototype.getAuthDate = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PostServiceService = /** @class */ (function () {
                ...
                PostServiceService.prototype.getOnePost = function (id) {
                    return this.http.get(backendUrl + id);
                };
                PostServiceService.prototype.getPosts = function (postPerPage, currentPage) {
                    var _this = this;
                    ...
                    this.http
                        ...
                        _this.posts = transformedPosts.post;
                        _this.postUpdated.next({
                            post: _this.posts.slice(),
                            postCounter: transformedPosts.maxPost
                        });
                    });
                };
                PostServiceService.prototype.getPostUpdateListener = function () {
                    return this.postUpdated.asObservable();
                };
                // tslint:disable-next-line:variable-name
                PostServiceService.prototype.addPost = function (tittle, content_, image) {
                    var _this = this;
                ...
                PostServiceService.prototype.deletePost = function (id) {
                    return this.http.delete(backendUrl + id);
                };
                // tslint:disable-next-line:variable-name
                PostServiceService.prototype.updatePost = function (id, tittle, content_, image) {
                    var _this = this;
                    var postData;
